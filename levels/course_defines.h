...
DEFINE_COURSE(COURSE_HAZY_CASTLE,0x22222240)       // (17) Hazy Castle
DEFINE_COURSES_END()
DEFINE_BONUS_COURSE(COURSE_BITDW,    0x34444440) // (18) Bowser in the Dark World
DEFINE_BONUS_COURSE(COURSE_BITFS,    0x34444440) // (19) Bowser in the Fire Sea
DEFINE_BONUS_COURSE(COURSE_BITS,     0x34444440) // (20) Bowser in the Sky
DEFINE_BONUS_COURSE(COURSE_PSS,      0x24444440) // (21) The Princess's Secret Slide
DEFINE_BONUS_COURSE(COURSE_COTMC,    0x44444440) // (22) Cavern of the Metal Cap
DEFINE_BONUS_COURSE(COURSE_VCUTM,    0x24444440) // (23) Vanish Cap under the Moat
