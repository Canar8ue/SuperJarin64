...
COURSE_ACTS(COURSE_TOTWC, _("16 BOWSER'S FOREST"),
       _("TOP OF THE GATEHOUSE")         , _("8 RED COINS OF THE SKY RING")  , _("SECRET OF THE CLIFFSIDE"),
       _("THE FORTRESS GUARDIAN")        , _("DUNGEON DEPTHS")               , _("HIDDEN DUNGEON STAR"))

COURSE_ACTS(COURSE_HAZY_CASTLE, _("17 HAZY CASTLE"),
       _("RED COINS OF THE GRAVEYARD")    , _("THE FRIENDLY BOO'S SECRET")    , _("GHOST OF THE LIBRARY"),
       _("DUNGEON POOL CLIMB")           , _("ASCENT TO THE HIGHEST SPIRE")  , _("FIVE FOREST SECRETS"))
